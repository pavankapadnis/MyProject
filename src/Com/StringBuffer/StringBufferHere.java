...
public class StringBufferHere {
	...
	public static void main(String[] args) {
		...
		sb.reverse();
		System.out.println("Reverse StringBuffer sb in sb1 = " + sb + "\n");
		...
		// Find the lengtgh of sb2 StringBuffer.

		int ln = sb2.length();
		System.out.println(ln);

		// Here insert new string in StringBuffer sb2 At the end of sb2.
		...
		// To find Current capacity of StringBuffer sb2.
